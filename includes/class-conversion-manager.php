 ...
 * Manager Class
 */
class WC_Conversion_Tracking_Integration_Manager {
    /**
     * All integrations
     * @var array
     */
    ...
    public function includes_integration() {
        ...
        require_once WCCT_INCLUDES . "/getways/conversion-integration-facebook.php";
        require_once WCCT_INCLUDES . "/getways/conversion-integration-custom.php";
        require_once WCCT_INCLUDES . "/getways/conversion-integration-google.php";
        require_once WCCT_INCLUDES . "/getways/conversion-integration-twitter.php";
    }
    ...
    public function get_integrations() {
        $integrations = array(
            'WC_Conversion_Tracking_Gateway_Facebook',
            'WC_Conversion_Tracking_Gateway_Twitter',
            'WC_Conversion_Tracking_Gateway_Google',
            'WC_Conversion_Tracking_Gateway_Custom',
        );
        $this->integrations = apply_filters( 'wccv_gateways', $integrations );
                    ...
                    <div class="integration">
                        ...
                        <div class="integration-settings" id="setting-<?php echo $id?>">
                            ...
                            foreach ($settings as $field) {
                                ...
                                switch ($field['type']) {
                                    case 'text':
                                        echo '<td><input type="text" name="'.$id.'['.$field['name'].']" value="'.$integration_settings[$id][$field['name']].'"></td>';
                                        break;

                                    case 'textarea':
                                        echo '<td><textarea name="'.$id.'['.$field['name'].']" id="" cols="30" rows="3">'.$integration_settings[$id][$field['name']].'</textarea></td>';
                                        break;
                                    case 'checkbox':
                                        ?>
                                        <td>
